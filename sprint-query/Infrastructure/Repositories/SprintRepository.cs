...
public class SprintRepository : ISprintRepository
{
    ...
    public SprintRepository(SprintsContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
    ...
    public async Task<IEnumerable<ISprint>> GetAllAsync()
    {
        var sprintDataModels = await _context.Set<SprintDataModel>().ToListAsync();
        var result = sprintDataModels.Select(_mapper.Map<SprintDataModel, Sprint>);
